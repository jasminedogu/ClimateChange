...
```
[text needs to go here about the tabled results]

```{r, include=FALSE}
#New York Time Sentiments
table(publication_afinn(nyt_freq))
nyt_affin<- publication_afinn(usa_freq)
...
```
[text needs to go here explaining the ggplot]
...
```
[text needs to go here explaining the wordcloud]
